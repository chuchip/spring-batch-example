package com.profesorpt.springbatch.config;
...
public class SpringBatchConfig {
	...
	{
		Step step=sbf.get("ETL-file-load")
				.<User,User>chunk(100)
				.reader(itemReader)
		...
		return jbf.get("ETL-Load")
		.incrementer(new RunIdIncrementer())
//		.flow(step) // Para multiples pasos.
//		.next(step)
		.start(step)
		.build();
	...
	@Bean
	public 	FlatFileItemReader<User> getItemReader(@Value("${input}") Resource resource)
	{
